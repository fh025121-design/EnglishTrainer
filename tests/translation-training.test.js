...
assert.strictEqual(questions[0].parts[0].selections[0].options[0], "私は", "the first selection should expose its first card option");
assert.strictEqual(questions[0].parts[1].selections[0].options[1], "本を読んだあと", "the second part should expose its second card option");
