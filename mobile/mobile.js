(function () {
  ...
  function showScreen(screenId) {
    ["homeScreen", "studyScreen", "resultScreen", "settingsScreen", "comingSoonScreen"].forEach((id) => {
  ...
  function bindEvents() {
    document.getElementById("startSpeakingBtn").addEventListener("click", () => startStudy("speaking"));
