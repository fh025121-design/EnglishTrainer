...
const sandbox = {
  ...
  document,
  state: { wordLearningState: {}, vocabularyStudy: { entries: [] }, vocabularyTodayHistoryMap: {} },
...
console.log('direct progress', sandbox.window.getWordLearningStateProgressEntries('learning'));
console.log('status list', sandbox.window.getVocabularyProgressListEntries('status', 'learning'));
