...
exports.executeSchemaMigration = executeSchemaMigration;
...
async function executeSchemaMigration(serviceName, diffs) {
    const client = dataconnectClient();
    const op = await client.post(`${serviceName}/schemas/main:migrate`, { diffs });
    await operationPoller.pollOperation({
        apiOrigin: (0, api_1.dataconnectOrigin)(),
        apiVersion: DATACONNECT_API_VERSION,
        operationResourceName: op.body.name,
