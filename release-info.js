window.ENGLISH_TRAINER_RELEASE_INFO = Object.freeze({
  adminPassword: "12345",
  releaseHistory: [
    { version: "2026/07/22 19:36", note: "スマホ版Speakingの最小修正: Day再開時に保存進捗がconversationCompleteなら通常練習へ入らず既存遷移で次周回開始へ進むよう修正。安全策として練習画面入口でもconversationCompleteを検知して完了画面または次周回開始処理へリダイレクト" },
